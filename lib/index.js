...
function copyFileFromDistToDirectorySync(destinationRelativeDirectoryPath, filename) {
  ...
  fs.copyFileSync(sourcePath, destinationRelativeDirectoryPath);
}
...
function writeAssetsArchiveToDirectorySync(destinationRelativeDirectoryPath) {
  ...
  copyFileFromDistToDirectorySync(destinationRelativeDirectoryPath, CSP_STYLESHEET_FILENAME);
}
...
async function unzipAssetsArchiveToDirectory(destinationRelativeDirectoryPath) {
  ...
  await unzipFileFromDistToDirectory(CSP_STYLESHEET_FILENAME, destinationRelativeDirectoryPath);
}
